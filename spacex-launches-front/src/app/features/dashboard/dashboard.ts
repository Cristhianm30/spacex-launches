...
import { LaunchDetailModal } from '../../components/launch-detail-modal/launch-detail-modal';
import { LaunchService } from '../../shared/services/launch.service';
import {
  LaunchSummaryResponse,
  StatsDataResponse,
  LaunchPageResponse,
} from '../../shared/models/launch.models';
...
@Component({
  ...
  imports: [CommonModule, LaunchCard, LaunchDetailModal, Dropdown],
...
export class Dashboard implements OnInit {
  ...
  private loadPaginatedLaunches(): void {
    ...
    this.launchService
      .getPaginatedLaunches(this.currentPage, this.pageSize, this.selectedStatus)
      .subscribe({
  ...
  onLaunchCardClick(launchId: string): void {
